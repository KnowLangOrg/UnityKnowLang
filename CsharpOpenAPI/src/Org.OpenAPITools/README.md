...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IChatApi>();
            StreamChatApiV1ChatStreamGetApiResponse apiResponse = await api.StreamChatApiV1ChatStreamGetAsync("todo");
...
## Api Information
- appName: KnowLang API
- appVersion: 1.0.0
- appDescription: A FastAPI server for the KnowLang project, providing endpoints for all KnowLang features.
