...
namespace Org.OpenAPITools.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new ChatStatusJsonConverter());
            _jsonOptions.Converters.Add(new ChatStatusNullableJsonConverter());
            _jsonOptions.Converters.Add(new HTTPValidationErrorJsonConverter());
            _jsonOptions.Converters.Add(new ParseCommandArgsJsonConverter());
            _jsonOptions.Converters.Add(new SearchResultJsonConverter());
            _jsonOptions.Converters.Add(new ServerSentChatEventJsonConverter());
            _jsonOptions.Converters.Add(new StreamingChatResultJsonConverter());
            ...
            _services.AddTransient<IParseApi, ParseApi>();
        }
            ...
            Action<HttpClient>? client = null, Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IParseApi, ParseApi>(client));
