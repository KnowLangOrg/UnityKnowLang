        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is ChatStatus chatStatus)
                return ChatStatusValueConverter.ToJsonValue(chatStatus);
            if (obj is ParseCommandArgs.OutputEnum parseCommandArgsOutputEnum)
                return ParseCommandArgs.OutputEnumToJsonValue(parseCommandArgsOutputEnum);
            if (obj is ParseCommandArgs.CommandEnum parseCommandArgsCommandEnum)
                return ParseCommandArgs.CommandEnumToJsonValue(parseCommandArgsCommandEnum);
